(ns app.server.episode.material-circulation-test
  ...
  (:require [app.server.episode.material-circulation :as circulation]
            ...
            [app.server.worn.provenance-material :as material]
...
(deftest terminal-escape-detector-counts-policy-commits-after-activation
  (let [commits [{:sha "old" :committed-at-ms 100
                  :subject "old policy"
                  :files ["src/app/server/worn/provenance_material.cljc"]}
