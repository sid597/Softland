(ns app.server.page.reply-to-block-test
  ...
  (:require [app.server.ingest.clojure-adapter :as clj-adapter]
            [app.server.rama.object-container.runtime :as ocr]
            [app.server.page.material-portal :as material-portal]
            [app.server.page.verb-release :as release]
            [app.server.worn.attention-material :as attention]
            [app.server.worn.invocation-material :as invocation]
            [app.server.page.reply-to-block :as reply]
...
(deftest portal-proves-the-release-row-is-worn
  (let [bindings-of @(ns-resolve 'app.server.page.material-portal 'bindings-of)
