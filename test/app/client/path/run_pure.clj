...
;; (which loads Rama). Runs the eight namespaces that carry the definer's
...
;;   (map :kind (:regions (c/run r/z-as-dabs {})))   ; 24 dabs
;;   (c/classify r/harness-z [64.0 64.0])             ; :inside, once
