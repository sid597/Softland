...
**Precedence vs AGENTS.md:** AGENTS.md is the BINDING project doc, and
...
note). AGENTS.md carries the one-line versions; cite this skill when the
precise mechanism, scope fence, or evidence matters. Only A4 (AGENTS.md
