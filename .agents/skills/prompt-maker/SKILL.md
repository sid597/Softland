...
The flavorings, each one line to append. Output all of them, and beside
each one sentence tied to this chat: what that room might find that the
chat is missing. That sentence stays outside the prompt.
