...
- [First-record research application](project-first-record-research-application.md) — 21 Sept 2026 state: ONE pass-on document, src/proposal/first-record-2026-09-20/CORNERS.md (picture, a page per corner, redrawn unruled ledger); research, pilot and first handoff retired to history/proposals/; first ask to Sid is the saying.
