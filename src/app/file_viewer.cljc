(ns app.file-viewer
  "The Electric face/trail artery: land boot context (face-ctx,
   trail-runtime-ref), the Trail* bridge e/defns, FacePull, RecordFaceWear,
   LiveEdges, and WatchIngestEpoch."
