...
| [NOTATIONS.md](NOTATIONS.md) | the proposal in native notations: envelope, rules, the walk as a trace, findings; the walk's rulings folded in with marks on 17 September | the 15 September session, updated 17 September |
...
| [FALSIFICATION.md](FALSIFICATION.md) | another session's three falsification passes over the frame, sorted under layer −1, layer 0, and the eight parts, each point with what it touches in the ledger; not adjudicated | the 17 September session, from Sid's paste |
...
has said and at what weight; every part has now been presented and held, and
the go question is still his.
