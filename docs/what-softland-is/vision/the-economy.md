...
> one provenance ledger (constitution material); the marketplace thread
> also rides the bet ladder (BETS C3) — this file is testimony, never a
> status.

## Its a whole economy (LOG 2026-07-04)

Said as a correction — the session had claimed Softland tries to make "the
personhood qualities of knowledge transmissible without the person":
...
## The world platform (LOG 2026-08-10)
