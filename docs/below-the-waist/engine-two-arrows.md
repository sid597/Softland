...
§7a named the gap as it stood in the last living host. The waist cut (closed 2026-08-21) changed it, and the electric-native road (`docs/electric-native/DIRECTION.md`, settled 08-12/13) was written *before* that cut — so first the gap as it is today, then the fill, then what the cut did to the road's order.
...
> This section is a landed position, not a contract — contest it. If it is to be built, the next step is a contract cut (one document: scope · laws · entry points · 3–5 scenarios · MUST-NOTs) with the courier position above as its one open fork — and the Block probe stays the named instance that decides the host.
...
- `docs/decisions.md` §"One render substrate" (:302) and §"The render seam" (:450-628) — the binding law; `docs/scene-substrate/CONTRACT.md` §7 traps T1–T11; `vision/LOG.md` 2026-08-03 and 2026-08-12 entries (Sid's words, verbatim).
...
- Receipts: `docs/electric-skill/VERDICTS.md`, `PROBE-EVIDENCE.md`, `HACKS-LEDGER.md`; `docs/render-engine/PERF-DOSSIER-2026-08-09.md`; `docs/shaping-correction/CONTRACT.md`; `docs/render-substrate-retro/RETRO.md`, `PRIMITIVES.md`; `docs/electric-native/DIRECTION.md`, `PROBLEM-SPACE.md`, `RECON.md`; the electric-docs skill §2 laws.
