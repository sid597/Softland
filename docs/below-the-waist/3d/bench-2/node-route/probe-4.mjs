...
//   node docs/below-the-waist/3d/bench-2/node-route/probe-4.mjs                       # the committed bench's functions + the sidecars (the route before the bench takes the change)
//   node docs/below-the-waist/3d/bench-2/node-route/probe-4.mjs --bench <path|ref>    # the bench's embedded block executed as embedded, with custody of every sidecar unit
//   node docs/below-the-waist/3d/bench-2/node-route/probe-4.mjs --cold < continuation.json   # resume a suspended brush in a new process, print the summary
//   node docs/below-the-waist/3d/bench-2/node-route/probe-4.mjs --record <file.json> [--budget <n>]   # run a pasted record (a cold author's, say) and print its summary
