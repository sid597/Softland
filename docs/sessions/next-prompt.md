...
**META (07-16):** memory refound + soul dig staged — handoff `docs/sessions/soul-dig-and-memory-refound.md` (dig prompt ready to paste · MEMORY.md v3 proposal awaiting Sid's redlines/"restructure" · exploration-at-settlement law proposed · Sid's owed one-breath calls listed in its §5 ledger).
