...
v2 under sense-line-first · 2026-07-10 · one-paste opening brief for a fresh
design session (Sid's). Supersedes the 2026-07-06 ui-design-pass prompt
(pre-form-break). Boots with the design canon; no engineering constraint
gates in here — explore, render alternatives, pick by feel. Dreams welcome,
labeled as dreams.
...
4. **Feel-checks the spec is waiting on** (SPEC.md OPEN rulings 1–2): Sid's
   messages sub-chunked by default — rendered, does it feel right? Headers
   as their own blocks — same question.
...
write-gestures sketched here are design material, spec'd later (A2).
