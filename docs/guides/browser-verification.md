# Browser verification — desktop and renderer harnesses

These setup notes preserve recorded Chrome/CDP conditions and distinguish
desktop interaction from the renderer's automated checks. Check the cited
conditions and current launcher before applying an older observation. For
Inland's current commands, start with [the build guide](../builds/inland/README.md).
