...
- **below-the-waist cleanup** → `docs/below-the-waist/waist-cleanup-task.md` · `NOW.md` — **§1/SLUG/DESIGN-TOKENS CUT BUILT + RECEIPTED 2026-08-26; SID ACCEPTANCE PENDING.** The dead Region3D/render-floor tails, tape click road, scheduler, complete Slug road, and unused design tokens are gone. MSDF, scene order, `pick-region`, shadows, the Region3D composite, binding deltas, durable Rama/data/archive custody, and the live 3D kernel remain; §2 and §3 were not opened.
