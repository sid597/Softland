...
- **below-the-waist cleanup** → `docs/below-the-waist/waist-cleanup-task.md` · `NOW.md` — **§1/DESIGN-TOKENS CUT REMAINS CLOSED; TEXT-ROAD CORRECTION CLOSED + RECEIPTED 2026-08-28.** `e664b40` was reverted at `827d2ab` because “and slug goes” was mis-read as a ruling against Slug. MSDF, its text atlases/goldens/build hook, and its placed Region3D painter were removed at `dbf6c81`; Slug is the sole text road. Shared shaping/layout, placement math, scene order, `pick-region`, shadows, the Region3D composite, binding deltas, and durable Rama/data/archive custody remain; §2 and §3 were not opened.
