...
- **below-the-waist cleanup** → `docs/below-the-waist/waist-cleanup-task.md` · `NOW.md` — **§1/DESIGN-TOKENS CUT REMAINS CLOSED; TEXT-ROAD CORRECTION CLOSED + RECEIPTED 2026-08-28; CONDUCTOR CUT CLOSED + SID-ACCEPTED 2026-08-28.** `e664b40` was reverted at `827d2ab` because “and slug goes” was mis-read as a ruling against Slug. MSDF, its text atlases/goldens/build hook, and its placed Region3D painter were removed at `dbf6c81`; Slug is the sole text road. Shared shaping/layout, placement math, `pick-region`, shadows, the Region3D composite, and durable Rama/data/archive custody remain; §2 and §3 were not opened. **Conductor cut (scene tape, frame graph, delta spine, maintain zone) — Sid's ruling 2026-08-28; painters kept as libraries with no caller; no replacement built** (`c13711c` moves · `bff327e` cut; receipts in `NOW.md`).
