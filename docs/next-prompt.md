...
- **below-the-waist cleanup** → `docs/below-the-waist/waist-cleanup-task.md` · `NOW.md` — **ORIGINAL CUT ACCEPTED 2026-08-21; FOLLOW-ON FACE RECIPE/COMPILER CUT CLOSED 2026-08-24, SID ACCEPTANCE PENDING; ORPHAN/CLASS-PAPER CUT BUILT + RECEIPTED 2026-08-26, SID ACCEPTANCE PENDING.** The two unused maintained-frame twins and their dead state closure are gone; render-family registration now carries only family admission plus required paint keys. Durable Rama/data/archive custody and the live 3D kernel remain; the 3D product fork is still Sid-only.
