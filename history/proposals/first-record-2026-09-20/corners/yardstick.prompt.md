...
FILE: src/proposal/first-record-2026-09-20/research/@@NAME@@.md (@@LINES@@ lines)
...
after. One row per range, in file order, covering the file from line 1 to line @@LINES@@:
...
@@LINES@@ exactly once, in order, with no gaps and no overlaps.
