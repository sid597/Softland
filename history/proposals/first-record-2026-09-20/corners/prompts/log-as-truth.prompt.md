...
FILE: src/proposal/first-record-2026-09-20/research/log-as-truth.md (746 lines)
...
after. One row per range, in file order, covering the file from line 1 to line 746:
...
746 exactly once, in order, with no gaps and no overlaps.
