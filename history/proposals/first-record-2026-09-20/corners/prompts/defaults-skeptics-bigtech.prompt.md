...
FILE: src/proposal/first-record-2026-09-20/research/defaults-skeptics-bigtech.md (443 lines)
...
after. One row per range, in file order, covering the file from line 1 to line 443:
...
443 exactly once, in order, with no gaps and no overlaps.
