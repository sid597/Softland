...
FILE: src/proposal/first-record-2026-09-20/research/meaning-objects-substrates.md (3160 lines)
...
after. One row per range, in file order, covering the file from line 1 to line 3160:
...
3160 exactly once, in order, with no gaps and no overlaps.
