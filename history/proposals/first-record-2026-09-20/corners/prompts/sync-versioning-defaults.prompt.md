...
FILE: src/proposal/first-record-2026-09-20/research/sync-versioning-defaults.md (3683 lines)
...
after. One row per range, in file order, covering the file from line 1 to line 3683:
...
3683 exactly once, in order, with no gaps and no overlaps.
