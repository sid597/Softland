...
FILE: src/proposal/first-record-2026-09-20/research/facts-datalog.md (1090 lines)
...
after. One row per range, in file order, covering the file from line 1 to line 1090:
...
1090 exactly once, in order, with no gaps and no overlaps.
