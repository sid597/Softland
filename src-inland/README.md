...
explain immediate children; function lists and algorithm explanations belong with
source. The [client documentation rules](../src/app/client/AGENTS.md) apply to this
hierarchy too: update child contracts and the affected parent relationship in the
same change. A source description is not a runtime receipt; limitations stay
beside the relevant function and demonstrated claims link to saved evidence.
